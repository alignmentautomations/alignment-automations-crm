...
const MODULES = {
  ...
  starter_site: {
    ...
    alignment: [
      { name:"Confirm scope: 5 pages, fixed count · extra pages quoted separately", done:false, section:"Phase 0 · Sale" },
      ...
      { name:"Build the 5 page mobile-first site", done:false, section:"Phase 2 · Build" },
