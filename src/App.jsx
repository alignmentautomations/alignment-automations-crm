...
function DetailPanel({ clinic, onClose, onUpdate, onTriggerManual }) {{
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <div>
          <div style={{ fontSize: 14, fontWeight: 700, color: '#f8fafc' }}>
            {/* Matches the IDs in your DEFAULT_SEQUENCES */}
  ...
  {/* --- NEW INTEGRATION BLOCK END --- */}

  {/* Keep your existing Status and Contact Info sections below this */}
  <div>
...
// Inside FollowupView.jsx
// Replace MOCK_ACTIVE with a filtered list of your real clinics
